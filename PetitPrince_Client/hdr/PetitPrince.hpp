...
#ifndef __PetitPrince_hh__
#define __PetitPrince_hh__
...
# define USE_stub_in_nt_dll_NOT_DEFINED_PetitPrince
#endif
#ifndef  USE_core_stub_in_nt_dll
# define USE_core_stub_in_nt_dll_NOT_DEFINED_PetitPrince
#endif
#ifndef  USE_dyn_stub_in_nt_dll
# define USE_dyn_stub_in_nt_dll_NOT_DEFINED_PetitPrince
#endif
...
#define __PetitPrince_mDrawService__
  ...
  public:
    ...
    class NonApplicable : public ::CORBA::UserException {
    public:
      ...
      inline NonApplicable() {
        pd_insertToAnyFn    = insertToAnyFn;
        pd_insertToAnyFnNCP = insertToAnyFnNCP;
      }
      NonApplicable(const NonApplicable&);
      NonApplicable(const char* i_msg);
      NonApplicable& operator=(const NonApplicable&);
      virtual ~NonApplicable();
      virtual void _raise() const;
      static NonApplicable* _downcast(::CORBA::Exception*);
      static const NonApplicable* _downcast(const ::CORBA::Exception*);
      static inline NonApplicable* _narrow(::CORBA::Exception* _e) {
        return _downcast(_e);
      }
    ...
    static _dyn_attr const ::CORBA::TypeCode_ptr _tc_NonApplicable;

    class UnexpectedDraw : public ::CORBA::UserException {
    public:
      ...
      inline UnexpectedDraw() {
        pd_insertToAnyFn    = insertToAnyFn;
        pd_insertToAnyFnNCP = insertToAnyFnNCP;
      }
      UnexpectedDraw(const UnexpectedDraw&);
      UnexpectedDraw(const char* i_msg);
      UnexpectedDraw& operator=(const UnexpectedDraw&);
      virtual ~UnexpectedDraw();
      virtual void _raise() const;
      static UnexpectedDraw* _downcast(::CORBA::Exception*);
      static const UnexpectedDraw* _downcast(const ::CORBA::Exception*);
      static inline UnexpectedDraw* _narrow(::CORBA::Exception* _e) {
        return _downcast(_e);
      }
    ...
    static _dyn_attr const ::CORBA::TypeCode_ptr _tc_UnexpectedDraw;
  ...
  {
  public:
    ::CORBA::Double area(::CORBA::Long id);
    ::CORBA::Double perimeter(::CORBA::Long id);
    void homothetie(::CORBA::Long id, ::CORBA::Double index);
    void translation(::CORBA::Long id, ::CORBA::Double x, ::CORBA::Double y);
    void rotation(::CORBA::Long id, ::CORBA::Double angle);
    void symCenter(::CORBA::Long id);
    void symAxial(::CORBA::Long id);
    void addDraw(::CORBA::Long pid, ::CORBA::Long cid);
    char* toString(::CORBA::Long id);
  ...
  public:
    ...
    virtual ::CORBA::Double area(::CORBA::Long id) = 0;
    virtual ::CORBA::Double perimeter(::CORBA::Long id) = 0;
    virtual void homothetie(::CORBA::Long id, ::CORBA::Double index) = 0;
    virtual void translation(::CORBA::Long id, ::CORBA::Double x, ::CORBA::Double y) = 0;
    virtual void rotation(::CORBA::Long id, ::CORBA::Double angle) = 0;
    virtual void symCenter(::CORBA::Long id) = 0;
    virtual void symAxial(::CORBA::Long id) = 0;
    virtual void addDraw(::CORBA::Long pid, ::CORBA::Long cid) = 0;
    virtual char* toString(::CORBA::Long id) = 0;
...
#define __PetitPrince_mPetitPrinceService__
  ...
  public:
    ...
    // Other IDL defined within this scope.
    class InvalidDrawParams : public ::CORBA::UserException {
    public:
      ...
      inline InvalidDrawParams() {
        pd_insertToAnyFn    = insertToAnyFn;
        pd_insertToAnyFnNCP = insertToAnyFnNCP;
      }
      InvalidDrawParams(const InvalidDrawParams&);
      InvalidDrawParams(const char* i_msg);
      InvalidDrawParams& operator=(const InvalidDrawParams&);
      virtual ~InvalidDrawParams();
      virtual void _raise() const;
      static InvalidDrawParams* _downcast(::CORBA::Exception*);
      static const InvalidDrawParams* _downcast(const ::CORBA::Exception*);
      static inline InvalidDrawParams* _narrow(::CORBA::Exception* _e) {
        return _downcast(_e);
      }
    ...
    static _dyn_attr const ::CORBA::TypeCode_ptr _tc_InvalidDrawParams;
  ...
  {
  public:
    ::CORBA::Long createLine(const char* author, const ::PetitPrince::Point& a, const ::PetitPrince::Point& b);
    ::CORBA::Long createCircle(const char* author, const ::PetitPrince::Point& center, ::CORBA::Double ray);
    ::CORBA::Long createEllipse(const char* author, const ::PetitPrince::Point& center, ::CORBA::Double long_ray, ::CORBA::Double short_ray);
    ::CORBA::Long createPolygon(const char* author, const ::PetitPrince::PointSeq& pts);
    LongSeq* getDraws(const char* author);
  ...
  public:
    ...
    virtual ::CORBA::Long createLine(const char* author, const ::PetitPrince::Point& a, const ::PetitPrince::Point& b) = 0;
    virtual ::CORBA::Long createCircle(const char* author, const ::PetitPrince::Point& center, ::CORBA::Double ray) = 0;
    virtual ::CORBA::Long createEllipse(const char* author, const ::PetitPrince::Point& center, ::CORBA::Double long_ray, ::CORBA::Double short_ray) = 0;
    virtual ::CORBA::Long createPolygon(const char* author, const ::PetitPrince::PointSeq& pts) = 0;
    virtual LongSeq* getDraws(const char* author) = 0;
...
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, PetitPrince::LongSeq*& _sp);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, const PetitPrince::LongSeq*& _sp);
...
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, const PetitPrince::DrawService::NonApplicable*& _sp);
...
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, const PetitPrince::DrawService::UnexpectedDraw*& _sp);
...
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, const PetitPrince::PetitPrinceService::InvalidDrawParams*& _sp);
...
#ifdef   USE_stub_in_nt_dll_NOT_DEFINED_PetitPrince
# undef  USE_stub_in_nt_dll
# undef  USE_stub_in_nt_dll_NOT_DEFINED_PetitPrince
#endif
#ifdef   USE_core_stub_in_nt_dll_NOT_DEFINED_PetitPrince
# undef  USE_core_stub_in_nt_dll
# undef  USE_core_stub_in_nt_dll_NOT_DEFINED_PetitPrince
#endif
#ifdef   USE_dyn_stub_in_nt_dll_NOT_DEFINED_PetitPrince
# undef  USE_dyn_stub_in_nt_dll
# undef  USE_dyn_stub_in_nt_dll_NOT_DEFINED_PetitPrince
#endif

#endif  // __PetitPrince_hh__
