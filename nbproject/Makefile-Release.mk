...
${OBJECTDIR}/src/PetitPrince_DynStub.o: src/PetitPrince_DynStub.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Ihdr -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PetitPrince_DynStub.o src/PetitPrince_DynStub.cpp

${OBJECTDIR}/src/PetitPrince_Stub.o: src/PetitPrince_Stub.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Ihdr -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PetitPrince_Stub.o src/PetitPrince_Stub.cpp
